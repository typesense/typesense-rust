...
pub struct ApiStatsResponse {
    ...
    #[serde(
        rename = "delete_requests_per_second",
    ...
    #[serde(
        rename = "import_requests_per_second",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "overloaded_requests_per_second",
        skip_serializing_if = "Option::is_none"
    )]
    pub overloaded_requests_per_second: Option<f64>,
    #[serde(
        rename = "pending_write_batches",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "search_requests_per_second",
        skip_serializing_if = "Option::is_none"
    )]
    pub search_requests_per_second: Option<f64>,
    #[serde(
        rename = "total_requests_per_second",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "write_requests_per_second",
        skip_serializing_if = "Option::is_none"
    )]
