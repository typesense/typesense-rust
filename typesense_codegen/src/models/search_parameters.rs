...
pub struct SearchParameters<'a> {
    ...
    pub nl_model_id: Option<Cow<'a, str>>,
    ...
    pub query_by_weights: Option<Cow<'a, str>>,
    ...
    pub text_match_type: Option<Cow<'a, str>>,
    ...
    #[serde(
        rename = "max_filter_by_candidates",
    ...
    pub facet_query: Option<Cow<'a, str>>,
    ...
    pub num_typos: Option<Cow<'a, str>>,
    ...
    pub highlight_full_fields: Option<Cow<'a, str>>,
    ...
    pub highlight_start_tag: Option<Cow<'a, str>>,
    ...
    pub highlight_end_tag: Option<Cow<'a, str>>,
    ...
    pub synonym_sets: Option<Cow<'a, str>>,
    ...
    #[serde(
        rename = "enable_typos_for_alpha_numerical_tokens",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub split_join_tokens: Option<Cow<'a, str>>,
    ...
    pub vector_query: Option<Cow<'a, str>>,
    ...
    pub facet_strategy: Option<Cow<'a, str>>,
    ...
    #[serde(
        rename = "conversation_model_id",
        skip_serializing_if = "Option::is_none"
    )]
    pub conversation_model_id: Option<Cow<'a, str>>,
