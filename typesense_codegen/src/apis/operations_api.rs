...
pub async fn take_snapshot(configuration: &configuration::Configuration, snapshot_path: &str) -> Result<crate::models::SuccessStatus, Error<TakeSnapshotError>> {
...
pub async fn vote(configuration: &configuration::Configuration, ) -> Result<crate::models::SuccessStatus, Error<VoteError>> {
    let local_var_configuration = configuration;
