...
pub async fn delete_documents(configuration: &configuration::Configuration, collection_name: &str, delete_documents_parameters: Option<DeleteDocumentsDeleteDocumentsParametersParameter>) -> Result<crate::models::DeleteDocuments200Response, Error<DeleteDocumentsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = delete_documents_parameters {
        local_var_req_builder = local_var_req_builder.query(&[("deleteDocumentsParameters", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn delete_search_override(configuration: &configuration::Configuration, collection_name: &str, override_id: &str) -> Result<crate::models::SearchOverride, Error<DeleteSearchOverrideError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_search_synonym(configuration: &configuration::Configuration, collection_name: &str, synonym_id: &str) -> Result<crate::models::SearchSynonym, Error<DeleteSearchSynonymError>> {
    let local_var_configuration = configuration;
...
pub async fn export_documents(configuration: &configuration::Configuration, collection_name: &str, export_documents_parameters: Option<ExportDocumentsExportDocumentsParametersParameter>) -> Result<String, Error<ExportDocumentsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = export_documents_parameters {
        local_var_req_builder = local_var_req_builder.query(&[("exportDocumentsParameters", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn get_search_override(configuration: &configuration::Configuration, collection_name: &str, override_id: &str) -> Result<crate::models::SearchOverride, Error<GetSearchOverrideError>> {
    let local_var_configuration = configuration;
...
pub async fn get_search_overrides(configuration: &configuration::Configuration, collection_name: &str) -> Result<crate::models::SearchOverridesResponse, Error<GetSearchOverridesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_search_synonym(configuration: &configuration::Configuration, collection_name: &str, synonym_id: &str) -> Result<crate::models::SearchSynonym, Error<GetSearchSynonymError>> {
    let local_var_configuration = configuration;
...
pub async fn get_search_synonyms(configuration: &configuration::Configuration, collection_name: &str) -> Result<crate::models::SearchSynonymsResponse, Error<GetSearchSynonymsError>> {
    let local_var_configuration = configuration;
...
pub async fn import_documents(configuration: &configuration::Configuration, collection_name: &str, body: &str, import_documents_parameters: Option<ImportDocumentsImportDocumentsParametersParameter>) -> Result<String, Error<ImportDocumentsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = import_documents_parameters {
        local_var_req_builder = local_var_req_builder.query(&[("importDocumentsParameters", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn index_document(configuration: &configuration::Configuration, collection_name: &str, body: serde_json::Value, action: Option<&str>) -> Result<serde_json::Value, Error<IndexDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn multi_search(configuration: &configuration::Configuration, multi_search_parameters: MultiSearchParameters, multi_search_searches_parameter: Option<crate::models::MultiSearchSearchesParameter>) -> Result<crate::models::MultiSearchResult, Error<MultiSearchError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.query(&[("multiSearchParameters", &multi_search_parameters.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    if let Some(ref local_var_apikey) = local_var_configuration.api_key {
...
pub async fn search_collection(configuration: &configuration::Configuration, collection_name: &str, search_parameters: SearchParameters) -> Result<crate::models::SearchResult, Error<SearchCollectionError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.query(&[("searchParameters", &search_parameters.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    if let Some(ref local_var_apikey) = local_var_configuration.api_key {
...
pub async fn update_document(configuration: &configuration::Configuration, collection_name: &str, document_id: &str, body: serde_json::Value) -> Result<serde_json::Value, Error<UpdateDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn upsert_search_override(configuration: &configuration::Configuration, collection_name: &str, override_id: &str, search_override_schema: crate::models::SearchOverrideSchema) -> Result<crate::models::SearchOverride, Error<UpsertSearchOverrideError>> {
    let local_var_configuration = configuration;
...
pub async fn upsert_search_synonym(configuration: &configuration::Configuration, collection_name: &str, synonym_id: &str, search_synonym_schema: crate::models::SearchSynonymSchema) -> Result<crate::models::SearchSynonym, Error<UpsertSearchSynonymError>> {
    let local_var_configuration = configuration;
