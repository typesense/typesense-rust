...
pub async fn get_collections(configuration: &configuration::Configuration, params: GetCollectionsParams) -> Result<Vec<models::CollectionResponse>, Error<GetCollectionsError>> {
