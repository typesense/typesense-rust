...
pub async fn create_collection(configuration: &configuration::Configuration, collection_schema: crate::models::CollectionSchema) -> Result<crate::models::CollectionResponse, Error<CreateCollectionError>> {
...
pub async fn delete_alias(configuration: &configuration::Configuration, alias_name: &str) -> Result<crate::models::CollectionAlias, Error<DeleteAliasError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_collection(configuration: &configuration::Configuration, collection_name: &str) -> Result<crate::models::CollectionResponse, Error<DeleteCollectionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_alias(configuration: &configuration::Configuration, alias_name: &str) -> Result<crate::models::CollectionAlias, Error<GetAliasError>> {
    let local_var_configuration = configuration;
...
pub async fn get_aliases(configuration: &configuration::Configuration, ) -> Result<crate::models::CollectionAliasesResponse, Error<GetAliasesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection(configuration: &configuration::Configuration, collection_name: &str) -> Result<crate::models::CollectionResponse, Error<GetCollectionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collections(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::CollectionResponse>, Error<GetCollectionsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_collection(configuration: &configuration::Configuration, collection_name: &str, collection_update_schema: crate::models::CollectionUpdateSchema) -> Result<crate::models::CollectionUpdateSchema, Error<UpdateCollectionError>> {
    let local_var_configuration = configuration;
...
pub async fn upsert_alias(configuration: &configuration::Configuration, alias_name: &str, collection_alias_schema: Option<crate::models::CollectionAliasSchema>) -> Result<crate::models::CollectionAlias, Error<UpsertAliasError>> {
    let local_var_configuration = configuration;
