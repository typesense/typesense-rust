use typesense::models::{PresetUpsertSchema, PresetUpsertSchemaValue, SearchParameters};
...
async fn run_test_presets_lifecycle() {
    ...
    let created_preset = upsert_result.unwrap();
    ...
    let retrieved_preset = retrieve_one_result.unwrap();
